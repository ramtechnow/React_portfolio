export default function Contact() {
  ...
  return (
    <section id="contact" className="relative flex flex-col bg-primary px-5 py-16 overflow-hidden">
      {/* Bubble Background */}
      ...
      <div className="flex flex-col items-center text-black relative z-10">
        <h1 className="text-4xl border-b-4 border-[#d9376e] mb-5 w-[140px] font-bold">Contact</h1>
