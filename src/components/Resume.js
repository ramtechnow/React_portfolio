...
export default function Resume() {
  ...
  return (
    <section
      id="resume"
      ref={sectionRef}
      className="relative bg-gradient-to-br from-pink-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 min-h-screen flex items-center justify-center px-15 py-20 overflow-hidden"
    >
      <BackgroundElements />
      ...
      <div className="container mx-auto max-w-6xl flex md:flex-row flex-col items-center justify-between relative z-10 gap-10 lg:gap-16">
        ...
        >
          ...
          >
            My <span className="text-[#d9376e]">Resume</span>
          </motion.h1>
